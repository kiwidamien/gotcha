  ...
  render() {
    ...
    return (
      <div className="instructions">
        ...
        <h4>To win:</h4>
        <p>Get 3 tokens of your color in a line at the <i>end</i> of a turn.</p>

        <h4>What can I do on my turn?</h4>
        <p>During your turn, you can either <b>place a token in a column</b>, or <b>slide a row</b>. You should know that</p>
        <ul>
          <li>Tokens that are not directly above the "base" (shown in blue) will fall out.</li>
          <li>Tokens fall to the lowest empty spot in columns above the space (like Connect4)</li>
        ...
        <p>Yes. If the other player slides 3 of your tokens into a line on their turn, you win.</p>

        <h4>Is it possible to draw?</h4>
        <p>Yes. If a move results in both players getting three in a row, the game is a draw.</p>
